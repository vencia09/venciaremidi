...
<div class="container visimisi">
    <div class="d-flex align-items-center mb-3">
        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="rgb(77 124 15)" class="bi bi-chat-left-quote-fill" viewBox="0 0 16 16">
            <path
    ...
    <div class="row">
        <div class="col-lg-6">
            ...
            <ul>
                ...
                <li>
                    <p class="headline-paragraph text-black-50">{{ $item->deskripsi }}</p>
                </li>
                @endforeach
            </ul>
        </div>
